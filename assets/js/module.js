export const unifyForm = document.getElementById('unify-form');
export const fullname = document.forms['unify-form']['name'];
export const email = document.forms['unify-form']['email'];
export const password = document.forms['unify-form']['password'];
export const confirmPassword = document.forms['unify-form']['c-password'];
